...
main() {
    ...
    # Resolve repo to the shell's physical path so string comparisons match
    # the helper's output. pwd -P resolves macOS /var -> /private/var without
    # making Git for Windows rewrite /tmp to a drive-letter path.
