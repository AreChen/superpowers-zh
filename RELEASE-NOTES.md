...
## v6.2.0-zh.1（2026-07-24）

### 上游版本对齐

- **对齐官方版本：** [`obra/superpowers v6.2.0`](https://github.com/obra/superpowers/releases/tag/v6.2.0)。
...
- **中文发行序号：** `zh.1`，表示这是上游 `v6.2.0` 基线上的第 1 个中文发行版。

### 中文本地化与适配

- 同步并翻译按计划隔离的 SDD 工作区、恢复原实现者、限定范围复审和五轮熔断流程。
- 用 `writing-good-tests.md` 替换旧测试反模式参考，加入字符串存在性陷阱、变更检测器陷阱、独立期望值和变异检查。
